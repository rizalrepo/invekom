        ...
        <div class="col-lg-12 col-md-12 col-12 my-3">
            ...
            <div class="d-flex justify-content-between align-items-center">
                <div class="mb-2 mb-lg-0">
                    <h4 class="mb-0"><i class="fas fa-plug-circle-check me-2"></i>Data Perbaikan</h4>
                </div>
                <div>
                ...
                <div class="table-responsive">
                    <table id="example1" class="table table-bordered table-hover table-striped dataTable">
                        ...
                        <tbody>
                            <?php
                            $no = 1;
                            $data = $con->query("SELECT * FROM baik bk LEFT JOIN rusak a ON bk.id_rusak = a.id_rusak LEFT JOIN inventaris b ON a.id_inventaris = b.id_inventaris ORDER BY bk.id_baik DESC");
