        ...
        <div class="col-lg-12 col-md-12 col-12 my-3">
            ...
            <div class="d-flex justify-content-between align-items-center">
                <div class="mb-2 mb-lg-0">
                    <h4 class="mb-0"><i class="fas fa-plug-circle-check me-2"></i>Tambah Data Perbaikan</h4>
                </div>
                <div>
                            ...
                            <div class="table-responsive">
                                <table id="example1" class="table table-bordered table-hover table-striped dataTable">
                                    ...
                                    <tbody>
                                        <?php
                                        $no = 1;
                                        $data = $con->query("SELECT * FROM rusak r LEFT JOIN inventaris a ON r.id_inventaris = a.id_inventaris LEFT JOIN kategori b ON a.id_kategori = b.id_kategori LEFT JOIN ruangan c ON a.id_ruangan = c.id_ruangan WHERE a.kondisi = 'Rusak' ORDER BY r.id_rusak DESC");
