                ...
                <div class="card smooth-shadow-md border border-bg-danger">
                    ...
                    <div class="card-body p-6">
                        <div class="mb-4 text-center">
                            <img src="<?= base_url() ?>/assets/images/logo.png" width="300px" class="mb-2" alt=""><br>
                            <h4 class="mb-2 text-black">Sistem Informasi Monitoring Inventaris Perangkat Komputer</h4>
                        </div>
                        <hr class="my-1">
                        <!-- Form -->
                        <form method="POST" action="" class="needs-validation" novalidate>
                            ...
                            <div>
                                <!-- Button -->
                                <div class="d-grid">
                                    <button type="submit" name="log" class="btn bg-dark-info text-white">Login <i class="bi bi-box-arrow-in-right"></i></button>
                                </div>
                            </div>
                        </form>
                    </div>
